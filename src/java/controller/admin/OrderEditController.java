...
public class OrderEditController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        transactions.setDepartment_id(department);
        String adminId = (String) req.getSession().getAttribute("admin_id");
        transactions.setAdmin_id(adminId);
        
        
        transactionService.edit(transactions);
        if (!transactions.getStatus().equals(OrderStatus.DONE)) {
            for (Ordered a : list) {
