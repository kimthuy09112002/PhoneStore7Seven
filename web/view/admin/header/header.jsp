                    ...
                    <ul class="navbar-nav align-items-center right-nav-link">
                        <c:forEach items="${department}" var="i">
                            <c:if test="${i.id == department_id}">
                                <li style="font-weight: bold;margin-right: 15px;display: flex;align-items: center;justify-content: center;gap: 0 10px;font-size: 17px;"><i class="fa-solid fa-location-dot"></i> Chi nhánh ${i.describe}</li>
                                </c:if>
                            </c:forEach>               
                        <li class="nav-item">
