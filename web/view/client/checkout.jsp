                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="checkout-left">
                                    ...
                                    <div class="aa-checkout-single-bill">
                                        <p style="font-size: 17px;font-weight: 800;">Chọn chi nhánh mua hàng</p>
                                        <select id="department" name="transaction_department" style="padding: 10px;width: 100%;">
                                            <c:forEach items="${department}" var="i">
                                                <option value="${i.id}" checked>${i.describe}</option>                                       
                                            </c:forEach>
                                        </select>
                                    </div>                             
